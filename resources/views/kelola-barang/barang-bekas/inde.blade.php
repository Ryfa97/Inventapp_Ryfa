...
<section class="section">
    <div class="section-header">
        <h1>Data Barang Bekas Deactivasi</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ route('home') }}">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="{{ route('home') }}">Kelola Barang</a></div>
            <div class="breadcrumb-item"><a href="{{ route('bekas') }}">Barang Bekas</a></div>
            {{-- <div class="breadcrumb-item">Table</div> --}}
        </div>
    </div>
    <div class="section-body">
        <h2 class="section-title">Data Table Barang Bekas Deactivasi</h2>
        <div class="row">
            <div class="col-12">
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h4>List Barang Bekas Deactivasi</h4>
